...
class CrashlyticsReportingManager(private val crashlytics: FirebaseCrashlytics) : CrashReportingManager {
    ...
    override fun setCustomKey(key: String, value: Boolean?) = crashlytics.setCustomKey(key, value
            ?: false)

    override fun setCustomKey(key: String, value: Double?) = crashlytics.setCustomKey(key, value
            ?: Int.MIN_VALUE.toDouble())

    override fun setCustomKey(key: String, value: Float?) = crashlytics.setCustomKey(key, value
            ?: Int.MIN_VALUE.toFloat())

    override fun setCustomKey(key: String, value: Int?) = crashlytics.setCustomKey(key, value
            ?: Int.MIN_VALUE)

    override fun setCustomKey(key: String, value: Long?) = crashlytics.setCustomKey(key, value
